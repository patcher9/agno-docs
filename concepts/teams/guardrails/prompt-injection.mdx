...
description: Learn about the Prompt Injection Guardrail and how to use it with your Teams.
---

The Prompt Injection Guardrail is a built-in guardrail that detects prompt injection attempts in the input of your Teams.
...
To provide your Team with the Prompt Injection Guardrail, you need to import it and pass it to the Team using the `pre_hooks` parameter:
...
team = Team(
    name="Prompt Injection Guardrail Team",
