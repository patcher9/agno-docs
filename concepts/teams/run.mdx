...
For comprehensive information about using Pydantic models for input validation and output schema definition, see the [Typesafe Agents](/concepts/agents/typesafe-agents) documentation. All patterns shown there apply to teams as well.
