...
You can define Pydantic models as schemas to validate input data and guarantee that Agent outputs follow a specific structure. You can also use a separate `parser_model` to handle output formatting.
