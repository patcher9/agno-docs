...
<Tip>
  If the user tells the Agent they like to ski, then future responses can
  reference this information to provide a more personalized experience.
</Tip>
...
<Note>
  Read more about Memory in the [Memory Overview](/concepts/memory/overview)
  page.
</Note>
