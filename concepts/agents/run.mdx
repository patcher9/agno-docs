...
If you are using custom tools, it will often be useful to be able to yield custom events. Your custom events will be yielded together with the rest of the expected Agno events.

Our recommended setup is to create your custom event class extending the `CustomEvent` one:
