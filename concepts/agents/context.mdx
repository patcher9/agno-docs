...
| `enable_agentic_knowledge_filters` | `bool`      | `False` | If True, let the agent choose the knowledge filters. See [knowledge](/concepts/knowledge/filters/introduction) for more information.                                                      |
...
If you have `enable_agentic_memory` enabled on your agent, the agent gets the ability to create/update user memories using tools.
