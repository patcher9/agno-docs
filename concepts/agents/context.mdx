...
The system message is built from the agent’s description, instructions, and other settings. An agent’s system message additionally includes delegation rules and coordination guidelines. For example:
