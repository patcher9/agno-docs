...
**Agents are AI programs where a language model determines the flow of execution.**

The core of an Agent is made of a model, tools and instructions:
...
- **Memory:** gives Agents the ability to store and recall information from previous interactions, allowing them to learn user behavior and personalize their responses.
...
- **Knowledge:** is domain-specific information that the Agent can **search at runtime** to make better decisions and provide accurate responses (RAG). Knowledge is stored in a vector database and this **search at runtime** pattern is known as Agentic RAG or Agentic Search.
...
<Tip>
  If this is your first time building agents, [start
  here](/introduction/quickstart) before diving into advanced concepts.
</Tip>
...
<CardGroup cols={2}>
  <Card
    ...
    icon="wrench"
    iconType="duotone"
    href="/concepts/agents/building-your-agent"
  >
  ...
  <Card
    ...
    icon="user-robot"
    iconType="duotone"
    href="/concepts/agents/running-your-agent"
  >
    Learn how to run your agents.
  </Card>
  <Card
