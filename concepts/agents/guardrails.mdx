...
To use the Agno built-in guardrails, you just need to import them and pass them to the Agent with the `pre_hooks` parameter:
...
You can some complete examples using the Agno Guardrails in the [examples](/examples/concepts/agents/guardrails) section.
