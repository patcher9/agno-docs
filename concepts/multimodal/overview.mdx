...
Agno agents support text, image, audio and video inputs and can generate text, image, audio and video outputs. For a complete overview, please checkout the [compatibility matrix](https://docs-v2.agno.com/concepts/models/compatibility#multimodal-support).
