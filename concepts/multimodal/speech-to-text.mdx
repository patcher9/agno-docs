...
Agno agents can transcribe audio files using different tools and models. You can use local processing with MLX Whisper, cloud services like OpenAI, or multimodal models like Gemini.
