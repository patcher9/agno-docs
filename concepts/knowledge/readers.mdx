...
reader = ReaderFactory.get_reader_for_url("https://example.com/doc.pdf")     # PDFUrlReader
```
...
| URLReader        | Fetches and processes content from web URLs              |
...
Now that you understand how readers work, check out the [Examples Section](http://localhost:3000/examples/introduction).