...
- **[PostgreSQL](/docs/documentation/db/postgres)** - Recommended for production
- **[SQLite](/docs/documentation/db/sqlite)** - Great for development and single-user applications  
- **[MySQL](/docs/documentation/db/mysql)** - Enterprise-ready relational database
- **[MongoDB](/docs/documentation/db/mongodb)** - Document-based NoSQL option
- **[Redis](/docs/documentation/db/redis)** - In-memory option for high performance
- **[In-Memory](/docs/documentation/db/in_memory)** - Temporary storage for testing
- **Cloud Options** - [DynamoDB](/docs/documentation/db/dynamodb), [Firestore](/docs/documentation/db/firestore), [GCS](/docs/documentation/db/gcs)
...
Check out the [AgentOS Knowledge](/docs/agent-os/knowledge-management) page for more in-depth information.

## Next Steps

- **[Vector Databases](/docs/documentation/knowledge/vectordb/introduction)** - Understand the embedding storage layer
- **[AgentOS](/docs/agent-os/introduction)** - Use your Knowledge in Agno AgentOS
- **[Database Setup](/docs/documentation/db/overview)** - Detailed database configuration guides
