...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/knowledge/vector_db/milvus_db/milvus_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/knowledge/vector_db/milvus_db/async_milvus_db.py)