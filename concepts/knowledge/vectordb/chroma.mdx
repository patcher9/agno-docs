...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/knowledge/vector_db/chroma_db/chroma_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/knowledge/vector_db/chroma_db/async_chroma_db.py)