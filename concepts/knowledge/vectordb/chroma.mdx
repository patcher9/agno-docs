...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/vector_dbs/chroma_db/chroma_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/vector_dbs/chroma_db/async_chroma_db.py)