...
- View [Sync Retriever](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/custom/retriever.py)
- View [Async Retriever](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/custom/async_retriever.py)