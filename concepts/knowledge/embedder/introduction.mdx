...
Most embeddings providers support batch embedding of lists of texts. This reduces API load, prevents rate limits and greatly speeds up the embedding process.
To enable this, simply set the `enable_batch` flag to `True` when defining your embedder.
