...
Learn more about [choosing chunking strategies](/concepts/knowledge/chunking/introduction).
...
<CardGroup cols={2}>
  ...
  <Card title="Embedders" icon="vector-square" href="/concepts/knowledge/embedder/introduction">
