...
<Note>
You can also use websockets for background workflows. See the [Workflow Websocket](https://github.com/agno-agi/agno/tree/v2.0/cookbook/workflows/_06_advanced_concepts/_05_background_execution/background_execution_using_websocket) example.
</Note>
