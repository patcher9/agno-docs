...
![Workflows](/images/workflows-flow.png)
...
See more on Pydantic as input in the [Advanced Workflows](/concepts/workflows/advanced) documentation.
...
<Note>
  ...
  ![Workflows Step IO](/images/workflows-step-io-flow.png)
</Note>
