...
You'll also need Docker to run the MCP Toolbox server and database for the examples.

## Quick Start

The fastest way to try MCPToolbox is with our complete working demo:

```bash
# Clone the repo and navigate to demo
git clone https://github.com/agno-agi/agno.git
cd agno/cookbook/tools/mcp/mcp_toolbox_demo

# Start database and MCP Toolbox server
docker-compose up -d
