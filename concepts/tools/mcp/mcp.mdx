...
## Using MCP in AgentOS

You can also run MCP servers in the AgentOS, which provides a web interface for interacting with your agents. Here's an example of a GitHub agent running in the AgentOS:

```python github_agentos.py
import asyncio
