...
agent = Agent(tools=[FirecrawlTools(scrape=False, crawl=True)], markdown=True)
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/tools/firecrawl_tools.py)
