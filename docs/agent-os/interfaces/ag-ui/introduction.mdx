...
You can see more in our [cookbook examples](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_os/interfaces/agui/).
...
See [cookbook examples](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_os/interfaces/agui/).
