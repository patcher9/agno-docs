...
<Note>
  For complete security setup instructions, including environment configuration and best practices, see the [Security Key](/docs/agent-os/security) documentation.
</Note>
