...
<Info>
  **Learn more about Agents**: Dive deeper into agent configuration, tools,
  ...
  Documentation](/docs/documentation/agents/introduction).
</Info>

### Work with a Team

- Switch the top toggle to Teams and pick a team.
- Teams can operate in different modes:
  - **Coordinate**: agents take turns and build on one another.
  - **Collaborate**: agents discuss and work together in parallel.
  - **Route**: your message is automatically sent to the best agent.
...
<Info>
  **Learn more about Teams**: Explore team modes, coordination strategies, and
  ...
  Documentation](/docs/documentation/teams/introduction).
</Info>
...
<Info>
  **Learn more about Workflows**: Discover workflow types, advanced patterns,
  ...
  Documentation](/docs/documentation/workflows/overview).
</Info>
...
<CardGroup cols={2}>
  <Card title="Basic AgentOS" icon="play" href="/examples/agent-os/basic">
    Minimal chat setup with a single agent
  </Card>
  <Card title="Demo AgentOS" icon="rocket" href="/examples/agent-os/demo">
    Richer demo with knowledge, storage, and multiple agents
  </Card>
  <Card
