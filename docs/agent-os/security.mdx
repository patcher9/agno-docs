---
title: "Security Key"
sidebarTitle: "Security Key"
description: "Generate, configure, and use Security Keys to protect your AgentOS instance with bearer-token authentication"
---
...
From the AgentOS control plane, generate a security key.
...
<Note>
  **How it works**: AgentOS reads `OS_SECURITY_KEY` into
  `settings.os_security_key`. If configured, requests without a valid
