...
<Note>
For more information on how to use custom functions, refer to the [Advanced](/docs/documentation/workflows/advanced) page.
</Note>

**See Example**: 
- [Sequence of Functions and Agents](/examples/use-cases/workflows/01-basic-workflows/sequence_of_functions_and_agents) - Complete workflow with functions and agents
...
**See Example**:
- [Function-Based Workflow](/examples/use-cases/workflows/01-basic-workflows/function_instead_of_steps) - Complete function-based workflow

For migration from 1.0 style workflows, refer to the page for [Migrating to Workflows 2.0](/docs/documentation/workflows/migration)
...
**See Examples**: 
- [Sequence of Steps](/examples/use-cases/workflows/01-basic-workflows/sequence_of_steps)
...
**More Examples**: 
- [Condition Steps Workflow](/examples/use-cases/workflows/02-workflows-conditional-execution/condition_steps_workflow_stream)
- [Condition with List of Steps](/examples/use-cases/workflows/02-workflows-conditional-execution/condition_with_list_of_steps)
...
**More Examples**: 
- [Parallel Steps Workflow](/examples/use-cases/workflows/04-workflows-parallel-execution/parallel_steps_workflow)
...
**More Examples**: 
- [Loop Steps Workflow](/examples/use-cases/workflows/03_workflows_loop_execution/loop_steps_workflow)
...
**More Examples**: 
- [Router Steps Workflow](/examples/use-cases/workflows/05_workflows_conditional_branching/router_steps_workflow)
...
**More Examples**: 
- [`workflow_using_steps.py`](/examples/use-cases/workflows/01-basic-workflows/workflow_using_steps)
- [`workflow_using_steps_nested.py`](/examples/use-cases/workflows/01-basic-workflows/workflow_using_steps_nested)
- [`selector_for_image_video_generation_pipelines.py`](/examples/use-cases/workflows/05_workflows_conditional_branching/selector_for_image_video_generation_pipelines)
...
**More Examples**: 
- [Condition and Parallel Steps (Streaming Example)](/examples/use-cases/workflows/02-workflows-conditional-execution/condition_and_parallel_steps_stream)
- [Loop with Parallel Steps (Streaming Example)](/examples/use-cases/workflows/03_workflows_loop_execution/loop_with_parallel_steps_stream)
- [Router with Loop Steps](/examples/use-cases/workflows/05_workflows_conditional_branching/router_with_loop_steps)
