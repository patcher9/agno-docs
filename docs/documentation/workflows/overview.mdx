...
Workflows excel at **deterministic agent automation**, while [Teams](/docs/documentation/teams/introduction) are designed for **dynamic agentic coordination**. Use workflows when you need predictable, repeatable processes; use teams when you need flexible, collaborative problem-solving.
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="play"
    href="/docs/agent-os/chat-interface#run-a-workflow"
  >
