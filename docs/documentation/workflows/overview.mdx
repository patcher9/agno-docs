...
When building multi-agent systems, there is often a need to control the flow of execution, and this is where Workflows come in. Workflows are best suited for deterministic agent automation, in comparison to [Teams](/docs/documentation/teams/introduction) which are designed for agentic coordination between agents.
...
See more on Pydantic as input in the [Structured Inputs](/docs/documentation/workflows/advanced#structured-inputs) documentation.
...
```
See the full [example](/examples/use-cases/workflows/01-basic-workflows/sequence_of_functions_and_agents) for more details.

<Tip> 
Use your workflows on the [AgentOS UI](https://os.agno.com/chat) to get started with your workflows.
</Tip>

![Workflow AgentOS Chat](/images/workflow-agent-os-chat.gif)

To learn more about how to start building workflow systems, check out the [development guide](/docs/documentation/workflows/types_of_workflows) page.