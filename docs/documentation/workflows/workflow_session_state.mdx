...
<CardGroup cols={2}>
  <Card
    ...
    icon="user"
    href="https://github.com/agno-agi/agno/blob/0f05201815bd43faaec8dfa3db74a91ecb690ec1/cookbook/workflows/_06_advanced_concepts/_04_shared_session_state/shared_session_state_with_agent.py"
  >
  ...
  <Card
    title="Team Examples"
    icon="users"
    href="https://github.com/agno-agi/agno/blob/0f05201815bd43faaec8dfa3db74a91ecb690ec1/cookbook/workflows/_06_advanced_concepts/_04_shared_session_state/shared_session_state_with_team.py"
  >
