...
It works by equipping your Agents with a database that they will use to store and retrieve their [sessions](/docs/documentation/agents/sessions) from.
...
Agents with a `db` will persist their [sessions](/docs/documentation/agents/sessions) in the database. You can also automatically add the persisted history to the context, effectively enabling Agents to persist sessions:
...
agent = Agent(
    ...
    num_history_messages=3, # Specify how many messages to add to the context
)
```
...
<Note>
Learn more about [Teams](/docs/documentation/teams/introduction) and [Workflows](/docs/documentation/workflows/overview), Agno abstractions to build multi-agent systems.
</Note>
...
- [DynamoDB](/docs/documentation/db/dynamodb)
- [FireStore](/docs/documentation/db/firestore)
- [JSON](/docs/documentation/db/json)
- [JSON on GCS](/docs/documentation/db/gcs)
- [MongoDB](/docs/documentation/db/mongodb)
- [MySQL](/docs/documentation/db/mysql)
- [Neon](/docs/documentation/db/neon)
- [PostgreSQL](/docs/documentation/db/postgres)
- [Redis](/docs/documentation/db/redis)
- [SingleStore](/docs/documentation/db/singlestore)
- [SQLite](/docs/documentation/db/sqlite)
- [Supabase](/docs/documentation/db/supabase)

We also support using an [In-Memory](/docs/documentation/db/in_memory) database. This is not recommended for production, but perfect for demos and testing.
