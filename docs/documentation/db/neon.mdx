...
You can also read more about the [`PostgresDb` class](/docs/documentation/db/postgres) in its section.
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/db/postgres/postgres_for_agent.py)
