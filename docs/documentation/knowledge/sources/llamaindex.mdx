...
agent = Agent(knowledge_base=knowledge_base, search_knowledge=True, debug_mode=True)
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/llamaindex_kb.py)
