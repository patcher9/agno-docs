...
## Developer Resources
- [Manual filtering](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/filters/pdf/filtering.py)
- [Manual filtering on load](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/filters/pdf/filtering_on_load.py)