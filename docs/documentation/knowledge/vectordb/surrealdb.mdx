...
- View [Cookbook (Sync)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/vector_dbs/surrealdb/surreal_db.py)
- View [Cookbook (Async)](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agent_concepts/knowledge/vector_dbs/surrealdb/async_surreal_db.py)