...
You can change the way your Agent behaves by changing the **system** message that is sent to the language model.
...
Will produce a system message like this:
...
- View [Cookbook](https://github.com/agno-agi/agno/blob/main/cookbook/agents/context_management/)