---
title: Memory
description: Learn about memory in agents.
---

Memory gives an Agent the ability to recall relevant information about users. 
...
<Note>
Read more about Memory in the [Memory Overview](/docs/documentation/memory/overview) page.
</Note>
