...
<Tip>You can find more toolkits in the [Toolkits](/docs/documentation/tools/toolkits) guide.</Tip>
...
- [Available toolkits](/docs/documentation/tools/toolkits)
- [Making your own toolkits](/docs/documentation/tools/custom-toolkits)
- [Using functions as tools](/docs/documentation/tools/tool-decorator)


## MCP Tools
Agno supports [Model Context Protocol (MCP)](/docs/documentation/tools/mcp) tools.
...
<Tip> Learn more about MCP tools in the [MCP tools](/docs/documentation/tools/mcp) guide.</Tip>

## Developer Resources

- View the [Agent schema](/reference/agents/agent)
- View the [Knowledge schema](/reference/knowledge/knowledge)
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/knowledge/)