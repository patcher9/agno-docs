...
- [Making your own toolkits](/tools/custom-toolkits)
- [Using functions as tools](/tools/tool-decorator)


## MCP Tools
Agno supports [Model Context Protocol (MCP)](/tools/mcp) tools.
...
<Tip> Learn more about MCP tools in the [MCP tools](/tools/mcp) guide.</Tip>
