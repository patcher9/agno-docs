...
description: Learn how to use structured input and output with Agents.
---
...
In addition to structured output, you can also configure Agents to expect structured input.
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/agents/input_and_output/)