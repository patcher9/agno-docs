...
In [**Coordinate Mode**](/docs/documentation/teams/modes/coordinate), the team leader delegates tasks to team members and synthesizes their outputs into a single cohesive response. 
...
In [**Route Mode**](/docs/documentation/teams/modes/route), the team leader forwards your run input to the most appropriate team member based on the content of the input. The member's response is returned directly to the user and the team leader doesn't interpret/transform the response.
...
In [**Collaborate Mode**](/docs/documentation/teams/modes/collaborate), all team members are given the same task and the team leader synthesizes their outputs into a cohesive response. 
