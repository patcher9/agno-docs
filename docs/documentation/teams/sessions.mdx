...
See more details in the [Agent Sessions](/docs/documentation/agents/sessions) documentation.
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/teams/session/)