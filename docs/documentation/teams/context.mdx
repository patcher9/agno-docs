...
You can change the way your Team behaves by changing the **system** message context that is sent to the language model.

In Agno, the system message is dynamically created using `description` and `instructions` and a number of other settings.

Understanding how these prompts are created will help you build better Multi-Agent Systems.

<Tip>
You can always set the `system_message` to override any dynamically generated system prompt.
</Tip>

See [Agent Context Engineering](/docs/documentation/agents/context) for more information.
...
See [dependencies](/docs/documentation/teams/dependencies) for how to do dependency injection for your user message.

## Chat history

If you have database storage enabled on your team, session history is automatically stored (see [sessions](/docs/documentation/teams/sessions)).
...
See more details on [sessions](/docs/documentation/teams/sessions#session-history).
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/teams/basic/)