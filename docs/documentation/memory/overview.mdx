...
Memories are stored in the database you provide to the Agent. In the [Storage](/docs/documentation/db/overview) section, you can read more about adding a database to your Agent and which databases are supported.
