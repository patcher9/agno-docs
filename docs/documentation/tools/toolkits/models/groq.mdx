...
- View [Transcription Example](https://github.com/agno-agi/agno/tree/v2.0/cookbook/models/groq/transcription_agent.py)
- View [Translation Example](https://github.com/agno-agi/agno/tree/v2.0/cookbook/models/groq/translation_agent.py)
