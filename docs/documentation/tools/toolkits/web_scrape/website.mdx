...
| ----------- | ----------- | ------- | ---------------------------------------------- |
| `knowledge` | `Knowledge` | `None`  | Optional Knowledge base to store website content |
...
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/tools/website_tools.py)
