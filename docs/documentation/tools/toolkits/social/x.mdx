...
<Note> Check out the [Tweet Analysis Agent](/examples/use-cases/agents/tweet-analysis-agent) for a more advanced example. </Note>
...
You can use `include_tools` or `exclude_tools` to modify the list of tools the agent has access to. Learn more about [selecting tools](/docs/documentation/tools/selecting-tools).

## Developer Resources

- View [Tools](https://github.com/agno-agi/agno/blob/main/libs/agno/agno/tools/x.py)
- View [Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/tools/x_tools.py)
- View [Tweet Analysis Agent Cookbook](https://github.com/agno-agi/agno/tree/v2.0/cookbook/examples/agents/social_media_agent.py)
