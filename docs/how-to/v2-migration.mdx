...
<Tip>
Reference the [v2.0 Changelog](/docs/how-to/v2-changelog) for the full list of changes.
</Tip>
...
[Agents](/docs/documentation/agents/introduction) and [Teams](/docs/documentation/teams/introduction) are the main building blocks in the Agno framework.
...
<Tip>
See the full list of changes in the [Agent Updates](/docs/how-to/v2-changelog#agent-updates) section of the changelog.
</Tip>
...
<Tip>
See more changes in the [Storage Updates](/docs/how-to/v2-changelog#storage) section of the changelog.
</Tip>
...
<Tip>
See more changes in the [Memory Updates](/docs/how-to/v2-changelog#memory) section of the changelog.
</Tip>
...
from any sources. For a full example of the usage, see the [Content Types](../documentation/knowledge/content_types) page.
...
<Tip>
See more changes in the [Knowledge Updates](/docs/how-to/v2-changelog#knowledge) section of the changelog.
</Tip>
...
<Tip>
Make sure to check our [comprehensive migration guide for Workflows](/docs/how-to/workflows-migration).
</Tip>


### 7. Playground -> AgentOS

Our `Playground` has been deprecated. Our new [AgentOS](/docs/agent-os/introduction) offering will substitute all usecases. 

See [AgentOS](/docs/agent-os/introduction) for more details!
