...
<Tip>
  Reference the [v2.0 Changelog](/docs/how-to/v2-changelog) for the full list of
  changes.
</Tip>
...
<Tip>
  ...
  Updates](/docs/how-to/v2-changelog#agent-updates) section of the changelog.
</Tip>
...
<Tip>
  See more changes in the [Storage Updates](/docs/how-to/v2-changelog#storage)
...
<Tip>
  See more changes in the [Memory Updates](/docs/how-to/v2-changelog#memory)
  section of the changelog.
</Tip>
...
<Tip>
  See more changes in the [Knowledge
  Updates](/docs/how-to/v2-changelog#knowledge) section of the changelog.
</Tip>
...
<Tip>
  ...
  Workflows](/docs/how-to/workflows-migration).
</Tip>
