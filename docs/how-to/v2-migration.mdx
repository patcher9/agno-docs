...
<Tip>
Reference the [v2.0 Changelog](/docs/how-to/v2-changelog) for more details on the changes.
</Tip>
...
[Agents](./getting_started/agents.mdx) and Teams are the main building blocks in the Agno framework.
...
<Tip>
See the [Agent Updates](/docs/how-to/v2-changelog#agent-updates) section of the v2.0 changelog for more details on these changes.
</Tip>
...
Our `Playground` has been deprecated. Our new platform offering will substitute all usage cases. 

See [AgentOS](/docs/agentos/introduction) for more details!
