...
After tinkering with your AgentOS locally, you'll want to take it to production. This section will walk you through the process of deploying your AgentOS to your own infrastructure.

<Note>
  Behind the scenes, AgentOS is a FastAPI app that you can run locally or in
  your cloud. It is designed to be easy to deploy and scale.
</Note>
