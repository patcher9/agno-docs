...
5. Configure your API keys in `infra/secrets/.env`:
...
6. Spin-up the infrastructure for our project:
...
**Which model should I use?**: We will be using OpenAI's GPT-5 Mini for this project. This model is good at using tools and following complex analysis instructions.
