...
| `id`         | `Optional[str]`              | `None`                        | Agent ID for the run                                                                               |
...
| `thinking`         | `Optional[str]`              | `None`                        | Any thinking content the model produced (used by Anthropic models)                                |
...
| `images`           | `Optional[List[ImageArtifact]]` | `None`                        | List of images attached to the response                                                           |
| `videos`           | `Optional[List[VideoArtifact]]` | `None`                        | List of videos attached to the response                                                           |
| `audio`            | `Optional[List[AudioArtifact]]` | `None`                        | List of audio snippets attached to the response                                                   |
| `response_audio`   | `Optional[AudioResponse]`    | `None`                        | The model's raw response in audio                                                                 |
...
| `id` | `str` | `""` | ID of the agent generating the event |
