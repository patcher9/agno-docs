...
| `metadata` | `RunOutputExtraData` | `None` | Extra data containing optional fields like `references`, `add_messages`, `history`, `reasoning_steps`, and `reasoning_messages` |
...
| `metadata` | `Optional[RunOutputExtraData]` | `None` | Additional response data |
