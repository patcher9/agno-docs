...
| `extra_data` | `RunOutputExtraData` | `None` | Extra data containing optional fields like `references`, `add_messages`, `history`, `reasoning_steps`, and `reasoning_messages` |
...
| `extra_data` | `Optional[RunOutputExtraData]` | `None` | Additional response data |
