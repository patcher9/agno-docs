...
```
https://your-agentos-instance.com/api
```
...
- When `OS_SECURITY_KEY` is set on the server, all routes require:
...
See the dedicated guide: [Secure your AgentOS with a Security Key](/docs/agent-os/security).
...
<CardGroup cols={2}>
  <Card
    title="Agents"
    icon="robot"
    href="/reference-api/schema/agents/get-agents"
  >
    Create, manage, and execute individual agent runs with tools and knowledge
  </Card>
  <Card title="Teams" icon="users" href="/reference-api/schema/teams/get-teams">
    Orchestrate multiple agents working together on complex tasks
  </Card>
  <Card
    title="Workflows"
    icon="diagram-project"
    href="/reference-api/schema/workflows/get-workflows"
  >
  ...
  <Card
    title="Sessions"
    icon="clock"
    href="/reference-api/schema/sessions/get-sessions"
  >
  ...
  <Card
    title="Memory"
    icon="brain"
    href="/reference-api/schema/memory/get-memory"
  >
  ...
  <Card
    title="Knowledge"
    icon="book"
    href="/reference-api/schema/knowledge/get-content"
  >
  ...
  <Card
    title="Evals"
    icon="chart-bar"
    href="/reference-api/schema/evals/get-eval-runs"
  >
