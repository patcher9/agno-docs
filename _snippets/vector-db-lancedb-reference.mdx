...
| `on_bad_vectors` | `str` | `None` | What to do if the vector is bad. One of "error", "drop", "fill", "null". |
| `fill_value` | `float` | `None` | The value to fill the vector with if on_bad_vectors is "fill". |
