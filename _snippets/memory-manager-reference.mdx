...
| Method | Description | Parameters | Returns |
|--------|-------------|------------|---------|
| `create_user_memories` | Creates memories from text or messages | `message: Optional[str] = None, messages: Optional[List[Message]] = None, id: Optional[str] = None, team_id: Optional[str] = None, user_id: Optional[str] = None` | `str` |
| `acreate_user_memories` | Creates memories from text or messages (Async) | `message: Optional[str] = None, messages: Optional[List[Message]] = None, id: Optional[str] = None, team_id: Optional[str] = None, user_id: Optional[str] = None` | `str` |
