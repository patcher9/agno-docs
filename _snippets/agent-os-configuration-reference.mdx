...
| `chat` | `Optional[ChatConfig]` | `None` | Configuration for the Chat page |
| `evals` | `Optional[EvalsConfig]` | `None` | Configuration for the Evals page |
| `knowledge` | `Optional[KnowledgeConfig]` | `None` | Configuration for the Knowledge page |
| `memory` | `Optional[MemoryConfig]` | `None` | Configuration for the Memory page |
| `session` | `Optional[SessionConfig]` | `None` | Configuration for the Session page |
| `metrics` | `Optional[MetricsConfig]` | `None` | Configuration for the Metrics page |
