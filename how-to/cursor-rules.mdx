---
title: Cursor Rules
description: Use Agno with AI-powered code assistants like Cursor
---

Using Cursor or another AI coding assistant with Agno? A `.cursorrules` file helps your AI understand Agno's patterns and best practices.
...
- Use correct parameter names and Agno patterns
- Choose the right approach (Agent vs Team vs Workflow)
- Follow performance optimizations (~3μs agent instantiation)
- Suggest tools and patterns that actually work with Agno

## For Contributors

If you're contributing to Agno itself, the `.cursorrules` file is already in the repository root:
