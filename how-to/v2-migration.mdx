...
The script supports PostgreSQL, MySQL, SQLite, and MongoDB. Update the database connection settings in the script and run it.
...
See [AG-UI interface docs](/agent-os/interfaces/ag-ui/introduction) for more details.
