...
<Tip>
You can also add your own middleware to AgentOS. See the [Custom Middleware in AgentOS](/examples/agent-os/custom/custom-middleware) example for more details.
</Tip>
