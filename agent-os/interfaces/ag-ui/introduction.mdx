...
<Note>
**Migration from Apps**: If you're migrating from `AGUIApp`, update your imports:
...
See the [v2 migration guide](/how-to/v2-migration#7-apps-interfaces) for complete steps.
</Note>
