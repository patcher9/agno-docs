...
- The ability to create and delete knowledge content

See here for a [complete example](/examples/agent_os/mcp/enable_mcp_example).
...
See here for a [complete example](/examples/agent_os/mcp/mcp_tools_example).
