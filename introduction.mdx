---
title: What is Agno?
description: A high-performance runtime for running multi-agent systems in your cloud.
mode: "wide"
---
...
Agno gives you the fastest framework for building agents with out of the box session management, memory, knowledge, human in the loop and MCP support. You can also build autonomous multi-agent teams, and step-based agentic workflows for full control over complex multi-step agentic processes.
