...
- [Structured IO at each Step level Team](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/01_structured_io_at_each_level/structured_io_at_each_step_level_team_stream.py)
- [Structured IO at each Step level Custom Function-1](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/01_structured_io_at_each_level/structured_io_at_each_step_level_function_1.py)
- [Structured IO at each Step level Custom Function-2](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/01_structured_io_at_each_level/structured_io_at_each_step_level_function_2.py)