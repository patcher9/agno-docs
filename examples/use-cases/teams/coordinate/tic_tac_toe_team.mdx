---
title: "Tic Tac Toe Team"
---

This example shows how to create a tic-tac-toe game team where two AI agents play against each other using the `coordinate` mode.

## Code

```python cookbook/examples/teams/coordinate_mode/tic_tac_toe_team.py
