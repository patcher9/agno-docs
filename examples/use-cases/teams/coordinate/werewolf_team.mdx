---
title: "Werewolf Game Team"
---

This example shows how to create a werewolf game simulation where AI agents play the classic social deduction game using the `coordinate` mode.

## Code

```python cookbook/examples/teams/coordinate_mode/werewolf_team.py
import asyncio
...
<Steps>
    ...
    <Step title="Install required libraries">
        ```bash
        pip install agno anthropic deepseek
        ```
    </Step>
