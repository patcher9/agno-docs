...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="book-bookmark"
    iconType="duotone"
    href="/examples/concepts/knowledge/rag"
  >
  ...
  <Card
    ...
    iconType="duotone"
    href="/examples/concepts/knowledge/search_type/hybrid-search"
  >
  ...
  <Card
    ...
    icon="database"
    iconType="duotone"
    href="/examples/concepts/knowledge/embedders"
  >
