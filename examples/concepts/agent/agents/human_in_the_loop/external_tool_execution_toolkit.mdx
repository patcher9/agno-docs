...
This example shows how to implement human-in-the-loop functionality in your Agno tools. It shows how to use external tool execution to execute a tool call outside of the agent.
