...
This cookbook shows how to implement Agentic RAG using Infinity Reranker. Infinity is a high-performance inference server for text-embeddings, reranking, and classification models.
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install agno anthropic infinity-client lancedb
    pip install "infinity-emb[all]"
    ```
  </Step>

  <Step title="Start Infinity Server">
    ```bash
    infinity_emb v2 --model-id BAAI/bge-reranker-base --port 7997
    ```
  </Step>
