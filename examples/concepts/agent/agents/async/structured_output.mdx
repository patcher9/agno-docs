...
This example demonstrates async agents with structured output using Pydantic models for movie script generation.
...
<Steps>
  ...
  <Step title="Install libraries">
    ```bash
    pip install -U openai agno pydantic rich
    ```
  </Step>
