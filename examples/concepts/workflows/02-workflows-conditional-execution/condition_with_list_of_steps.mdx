...
- [Condition with list of steps (async)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/02_workflows_conditional_execution/async/condition_with_list_of_steps.py)