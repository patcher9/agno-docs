...
from agno.workflows.condition import Condition
from agno.workflows.parallel import Parallel
from agno.workflows.step import Step
from agno.workflows.types import StepInput
...
- [Condition and Parallel Steps Workflow (sync)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/02_workflows_conditional_execution/sync/condition_and_parallel_steps.py)
- [Condition and Parallel Steps Workflow (async non-streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/02_workflows_conditional_execution/async/condition_and_parallel_steps.py)
- [Condition and Parallel Steps Workflow (async streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/02_workflows_conditional_execution/async/condition_and_parallel_steps_stream.py)