...
from agno.workflows.types import StepInput, StepOutput
...
- [Early Stop Workflow with Loop](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/02_early_stopping/early_stop_workflow_with_loop.py)
- [Early Stop Workflow with Parallel](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/02_early_stopping/early_stop_workflow_with_parallel.py)
- [Early Stop Workflow with Router](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/02_early_stopping/early_stop_workflow_with_router.py)
- [Early Stop Workflow with Step](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/02_early_stopping/early_stop_workflow_with_step.py)
- [Early Stop Workflow with Steps](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/06_advanced_concepts/02_early_stopping/early_stop_workflow_with_steps.py)