---
title: Access Session State in Custom Python Function Step
description: This example demonstrates how to access session state in a custom python function step
---
