...
- [Sequence of functions and agents (sync streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/01_basic_workflows/01_sequence_of_steps/sync/sequence_of_functions_and_agents_stream.py)
- [Sequence of functions and agents (async non-streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/01_basic_workflows/01_sequence_of_steps/async/sequence_of_functions_and_agents.py)
- [Sequence of functions and agents (async streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/01_basic_workflows/01_sequence_of_steps/async/sequence_of_functions_and_agents_stream.py)