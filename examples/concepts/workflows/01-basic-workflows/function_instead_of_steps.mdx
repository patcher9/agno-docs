...
from agno.workflows.types import WorkflowExecutionInput
...
- [Function instead of steps (sync streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/01_basic_workflows/03_function_instead_of_steps/sync/function_instead_of_steps_stream.py)
- [Function instead of steps (async non-streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/01_basic_workflows/03_function_instead_of_steps/async/function_instead_of_steps.py)
- [Function instead of steps (async streaming)](https://github.com/agno-agi/agno/tree/main/cookbook/workflows/01_basic_workflows/03_function_instead_of_steps/async/function_instead_of_steps_stream.py)