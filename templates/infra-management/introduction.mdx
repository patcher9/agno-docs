...
**Agno Templates** are standardized codebases for running Agentic Systems locally using Docker and in production on AWS. They help us manage our Agentic System as code.

![workspace](/images/workspace.png)

## Create a new infra template

Run `ag infra create` to create a new infra template, the command will ask your for a starter template and infra name.

<CodeGroup>

```bash Create Infra Template
ag infra create
```
